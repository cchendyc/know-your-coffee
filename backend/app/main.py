...
from .resolvers.queries import chain_type, claim_type, coffee_shop, query, user_type

type_defs = load_schema_from_path(Path(__file__).resolve().parents[1] / "schema.graphql")
schema = make_executable_schema(type_defs, query, mutation, coffee_shop, chain_type, user_type, claim_type)
